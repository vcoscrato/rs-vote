...
class BaseRollCallModel(ABC):
    ...
    @abstractmethod
    def fit(self, X: RollCallMatrix, X_val: Optional[RollCallMatrix] = None, epochs: int = 1000, lr: float = 0.01) -> 'BaseRollCallModel':
        """
    ...
    def _check_is_fitted(self):
        if not self._is_fitted:
            raise RuntimeError("This instance is not fitted yet. Call 'fit' with appropriate arguments before using this estimator.")
